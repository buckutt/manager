<template>
    <div class="changepin centerBlock">
        <div class="mdl-card mdl-shadow--2dp">
            ...
            <form @submit.prevent="change(currentPin, pin, confirmedPin)">
                <div class="mdl-card__supporting-text fullwidth">
                    ...
                    <mdl-textfield type="password" floating-label="Nouveau code PIN" v-model="pin" class="inputwidth"></mdl-textfield><br />
                    <mdl-textfield type="password" floating-label="Nouveau code PIN (confirmation)" v-model="confirmedPin" class="inputwidth"></mdl-textfield>
                </div>
                <div class="mdl-card__actions mdl-card--border">
                    <mdl-button colored raised class="mdl-js-ripple-effect inputwidth">Connexion</mdl-button>
                </div>
            </form>
        </div>
